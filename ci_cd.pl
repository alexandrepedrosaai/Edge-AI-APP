...
my $app_name = $ENV{'APP_NAME'} // "Edge-AI-APP";
my $version  = $ENV{'VERSION'}  // "1.0." . time();
my $registry = $ENV{'REGISTRY'} // "dockerhub.io/edge-ai";

print "==> Building project...\n";
system("./gradlew clean build") == 0 or die "Build failed!\n";
...
system("cp build/libs/$app_name.jar artifacts/$app_name-$version.jar") == 0 or die "Failed to copy JAR!\n";
