...
namespace MajoranaStarship {
    ...
    operation MajoranaStarshipEngineQuantumTimeCrystal(input : Double[]) : Complex {
        ...
        for i in 0..19 {
            ...
            let brokenSymmetry = Complex(Microsoft.Quantum.Math.ExpD(-d / 200.0), Microsoft.Quantum.Math.Log(1.0 + d)); // quebra de simetria temporal
            ...
            let latticeTime = Complex(Microsoft.Quantum.Math.Log(1.0 + d), Microsoft.Quantum.Math.ExpD(-d / 150.0)); // rede temporal discreta
            ...
            let recurrence = Complex(Microsoft.Quantum.Math.ExpD(-d / 100.0), Microsoft.Quantum.Math.Log(1.0 + d)); // recorrência temporal
