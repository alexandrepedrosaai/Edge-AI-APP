...
namespace MajoranaStarship {
    ...
    operation MajoranaStarshipEngineQuantumBlackHoles(input : Double[]) : Complex {
        ...
        for i in 0..19 {
            ...
            let rand1 = ContinuousUniform(0.0, 1.0);
            let rand2 = ContinuousUniform(0.0, 1.0);
            ...
            let rand3 = ContinuousUniform(0.0, 1.0);
            let rand4 = ContinuousUniform(0.0, 1.0);
            ...
            let rand3_sync = ContinuousUniform(0.0, 1.0);
            let rand4_sync = ContinuousUniform(0.0, 1.0);
